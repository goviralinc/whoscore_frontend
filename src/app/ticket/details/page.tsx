      ...
      <div className="px-5 pt-20">
        ...
        <div className="bg-black rounded-full px-4 py-2">
          <div className="flex justify-between gap-4 items-str">
            ...
            <Link href="/cashout" className="bg-[#67E59A] flex items-center justify-center w-32 rounded-full text-dark">
              Cash Out
            </Link>
          </div>
        </div>
...
function BetDetail() {
  return (
    <Accordion.Item value="item-1" className="bg-[#1B1B1B] rounded-2xl mb-5 pt-3 pb-5 px-1">
      <Accordion.Trigger className="bg-[#252525]  w-full flex justify-between items-center gap-3 p-3 text-dark-200 font-semibold rounded-full text-xs">
        <div className="flex items-center gap-2">
          <Image src="/SportyBet.png" alt="Sportbet logo" height={22} width={22} />
          <h2>Premier League</h2>
      ...
      <Accordion.Content>
        <div className="text-sm px-1 pt-2">
          ...
          <div className="flex justify-between gap-4 mb-2">
            <div>
              <span>Man City vs Arsenal</span>
              <strong className="text-[#67E59A] block mt-2">2 : 0 H2 | 56'</strong>
            </div>
