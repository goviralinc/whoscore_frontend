...
const Cashout = () => {
  const proceed = () => {
    toastSuccess("You have successfully cashed out N70,000", { id: "cashout" });
  };
    ...
    <div>
      <div className="flex items-center justify-between px-5 gap-4 bg-dark h-12">
        <div className="flex gap-2 items-center">
          <Link href="/ticket/details" className="w-6 h-6 bg-black rounded-full flex items-center justify-center">
            <IoCaretBack />
          </Link>
      ...
      <div className="px-5 pt-5">
        <div className="bg-[#1B1B1B] rounded-2xl mb-5 pt-3 pb-5 px-1">
          ...
          <div className="text-sm px-1 pt-2">
            <span className="text-xs text-dark-200 mb-2 block">30/08/2023 10:24AM</span>
        ...
        <div className="bg-[#1B1B1B] rounded-2xl mb-5 py-3 px-1">
          <label htmlFor="partialCashout" className="bg-[#252525] block mb-3 p-3 font-semibold rounded-full text-xs">
            <input type="radio" name="checkoutType" id="partialCashout" className="mt-1 mr-2" />

            <span>Partial Cashout</span>
          </label>

          <label htmlFor="fullCashout" className="bg-[#252525] block p-3 font-semibold rounded-full text-xs">
            <input type="radio" name="checkoutType" id="fullCashout" className="mt-1 mr-2" />
